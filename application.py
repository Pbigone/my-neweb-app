...
<body id="sample">
  <div class="textColumn">
    <h1>Congratulations your jenkins is comepleted!!</h1>
    <p>Your first/second AWS Elastic Beanstalk Python Application is now running on your own dedicated environment in the AWS Cloud</p>
  </div>
